...
We then compare the mean discussion size for 3-hour blocks during the day comparing our the simplest generative model and the full generative model to the empirical data.
